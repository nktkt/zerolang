...
function ChatCodeBlock({ children }) {
  ...
  const code = extractCodeText(codeEl?.props?.children).replace(/\n$/, "");
...
function ToolCallDisplay({ part }) {
  const toolName = getToolName(part);
  const config = TOOL_LABELS[toolName] ?? { label: toolName, pastLabel: toolName };
